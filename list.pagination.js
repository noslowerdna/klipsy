...
module.exports = function(options) {
    ...
    var refresh = function() {
        ...
        for (var i = 1; i <= pages; i++) {
            ...
            var className = isCurrentPage ? "active" : "";

            //console.log(i, left, right, currentPage, (currentPage - innerWindow), (currentPage + innerWindow), className);

            if (is.number(i, left, right, currentPage, innerWindow)) {
                item = pagingList.add({
                    page: isCurrentPage ? ("<span class='unclickable' onclick='return false;' style='color:black'>[<b>" + i + "</b>]</span>") : i,
                    dotted: false
                })[0];
                if (className) {
                ...
                item = pagingList.add({
                    page: "<span class='unclickable' onclick='return false;'>...</span>",
                    dotted: true
                })[0];
